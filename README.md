...
## Введение
На работе стоит задача разработки видеокурса, в рамках которой нужно озвучить текст и записать скринкасты. Поэтому цель проекта - попробовать реализовать модель TTS, которая смогла бы озвучивать текст вместо живого человека.
