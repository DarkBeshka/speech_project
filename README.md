...
`last_output.wav` - результат обучения на 130 эпохах. Звук очень похож на человеческую речь, но произношение по-прежнему не соответствует тексту. Обучение заняло более 20 часов.
