...
2. Также необходимо попробовать обучить модель на бОльшем количестве эпох, например 100;
3. Количество времени и сил, которое мне понадобилось на разработку модели, которая привела к получению даже далекого от удовлетворительного результата, несопоставимо велико. Это можно объяснить тем, что я никогда раньше не обучала свои собственные модели;
4. В дальнейшем можно будет также поэкспериментировать с другими синтезаторами, может быть, дадут более хороший результат(например, HiFi-GUN).
